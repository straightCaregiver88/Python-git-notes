//git commit
//git add / git add -am auto add+commit for stagins tuff
//git status 
//git config --global user.email "straightcaregiver88@gmail.com"  / git config -l
//git reset come back to a log showed in the git log
//git log show the commit inforamtion 'versions' /git log --stat
...
//git remote add origin https://github.com/straightCaregiver88/Python-git-notes.git
//git push origin master 
//git pull origin main --allow-unrelated-histories   
//git tag -d to delete a tag , without create a tag 
// git push origing --tags
// git push origing :ref/tags/tagname // deletes tags to the git repo
//
//ssh stuff
